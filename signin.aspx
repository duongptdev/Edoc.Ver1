                        ...
                        <div class="email-form w-form">
                            <div id="email-form" name="email-form" data-name="Email Form" method="post" class="form">
                                ...
                                <div class="password-field">
                                    ...
                                    <asp:TextBox ID="txtPass" runat="server" TextMode="Password" CssClass="form-field w-input"></asp:TextBox>
                                    <a href="#" class="eye-icon w-inline-block" onclick="showPassword()">
